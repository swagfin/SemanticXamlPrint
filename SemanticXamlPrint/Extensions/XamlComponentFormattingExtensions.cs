...
namespace SemanticXamlPrint
{
    internal static class XamlComponentFormattingExtensions
    {
        public static ComponentDrawingFormatting GetSystemDrawingProperties(this IXamlComponent component, ComponentDrawingFormatting parentFormatting)
        {
            ...
            {
                Font = new Font((string.IsNullOrEmpty(styleFmt.Font) ? parentFormatting.Font.Name : styleFmt.Font), ((styleFmt.FontSize <= 0) ? parentFormatting.Font.Size : styleFmt.FontSize), (string.IsNullOrEmpty(styleFmt.FontStyle) ? parentFormatting.Font.Style : GetOverridedFontStyle(styleFmt.FontStyle))),
        ...
        private static StringFormat GetConvertedStringFormat(string alignment)
        {
            ...
            {
                case "center": return new StringFormat { Alignment = StringAlignment.Center };
                case "right": return new StringFormat { Alignment = StringAlignment.Far };
                default: return new StringFormat { Alignment = StringAlignment.Near };
            }
        }
        ...
        public static bool HasBorderSide(string borderSides, string side)
        {
            ...
            string[] tokens = normalized.Split(new char[] { ',', '|', ';', ' ' }, System.StringSplitOptions.RemoveEmptyEntries);
